...
genPOSCAR(sublats,scvecs,sys_name='Magnesium Oxide Ball System',POS_name='MgOBallPOSCAR.vasp')
metr=100*(nsph/ncube-np.pi/6)/(np.pi/6)
print(metr) #0.523598=pi/6 is the ratio of the volume of a sphere to the volume of a cube in which it is circumbscribed. As the size of the unit cell increases, this should approach 0.
